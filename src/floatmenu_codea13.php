...
function floatmenu_codea13(array $arr){
    ...
    if(!isset($arr["tiktokLink"])){
        $arr["tiktokLink"]="";
    }
    if(!isset($arr["youtubeLink"])){
        $arr["youtubeLink"]="";
    }
    if(!isset($arr["backgroundColor"])){
        $arr["backgroundColor"]="#7f7272dd";
    }
    echo '
        <style>
            ...
            .floatmenu'.$GLOBALS["firstcard"].'::-webkit-scrollbar {
                display: none;
            }

            /* Hide scrollbar for IE, Edge and Firefox */

            .floatmenu'.$GLOBALS["firstcard"].' {
                -ms-overflow-style: none;  /* IE and Edge */
                scrollbar-width: none;  /* Firefox */
            }

            .mediamenu'.$GLOBALS["firstcard"].'{
                position:fixed;
            ...
            .mediamenushift'.$GLOBALS["firstcard"].'{
        ...
        <div id="mediamenu" class="mediamenu'.$GLOBALS["firstcard"].' mediamenushift'.$GLOBALS["firstcard"].'">
            ...
            var mastermenuarrow = document.querySelector("#menuarrow");
            mastermenuarrow.addEventListener("click", openMenuAndClose);
