...
function bcurve_block_codea13(array $arr)
{
    if (!isset($arr["title"])) {
    ...
    if (!isset($arr["topBorderColor"])) {
        $arr["topBorderColor"] = "black";
    }
    if (!isset($arr["bottomBorderColor"])) {
        $arr["bottomBorderColor"] = "black";
    }
    ...
    .home' . $GLOBALS["firstcard"] . '::after{
        ...
        .mainblock' . $GLOBALS["firstcard"] . '{
            min-height:400px;
            background:linear-gradient(180deg, ' . $arr["topBorderColor"] . ' 50%, rgba(10,122,100,1) 50%, ' . $arr["bottomBorderColor"] . ' 50%);
        ...
        .bk1' . $GLOBALS["firstcard"] . '{
            ...
            background-color:' . $arr["backgroundColor"] . ';
            height:50px;
            -webkit-mask-image:url("vendor/rezenebe/codea13/src/assets/bbcurve.svg");
        ...
        .bk2' . $GLOBALS["firstcard"] . '{
            ...
            background-color:' . $arr["backgroundColor"] . ';
            height:50px;
            -webkit-mask-image:url("vendor/rezenebe/codea13/src/assets/bcurve.svg");
            mask-repeat:no-repeat;
            mask-size: 100% 100%;
            border:none;
        }
