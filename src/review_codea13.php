...
Facere mollitia maxime accusamus vero incidunt sit.";
    ...
    if (!isset($arr["keyColor"])) {
        $arr["keyColor"] = "lightseagreen";
    }
    ...
    echo '
            <h2 id="maintitle' . $GLOBALS["firstcard"] . '" style="font-size:18px;color:' . $arr["keyColor"] . '; text-shadow:0.5px 0.5px black;">' . $studentNames[0] . '</h2>
