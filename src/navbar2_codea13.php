...
function navbar2_codea13(array $arr)
{
    ...
    if (!isset($arr["sliderColor"])) {
        $arr["sliderColor"] = "white";
    }
    ...
    <div id="logo-title" class="logo-title">
        <a href="' . $arr["homeLink"] . '"><img src="' . $arr["logo"] . '" alt="logo"></a>
    </div>
    ...
    for ($i = 0; $i < $arr["dropDownNumber"]; $i++) {
        echo '<span id="dropdown' . $i . '" style="display:' . $showDropDown . '; align-items:center"><span id="dropdownInner">' . $arr["dropDown"] . '</span><span id="dropdownArrow">' . $arrowdown_icon . '</span></span>';
    }
    ...
    for ($z = 0; $z < $arr["dropDownNumber"]; $z++) {
            ...
            if (isset($arr["dropTabs"])) {
                ...
                if (isset($arr_dropTabs_keys[$j])) {
                    ...
                    if (isset($arr["dropTabs"][$dkey])) {
                        echo '<a href="' . $arr["dropTabs"][$dkey] . '" style="color:' . $arr["dropDownTabsColor"] . '; width:100%; font-weight:bold;"><span class="droptabs" style="background-color:' . $arr["sliderColor"] . '">' . $arr_dropTabs_keys[$j] . '</span></a>';
                    }
                } else {
                    echo '<span class="droptabs" style="background-color:' . $arr["sliderColor"] . '">Entry' . ($j + 1) . '</span>';
                }
            } else {
                echo '<span class="droptabs" style="background-color:' . $arr["sliderColor"] . '">Entry' . ($j + 1) . '</span>';
            }
        ...
        echo '<div id="menudrawer" class="menudrawer" style="background-color:' . $arr["sliderColor"] . '">';
        ...
        for ($i = 0; $i < $arr["tabNumber"]; $i++) {
            ...
            if (isset($arr["tabs"])) {
                ...
                if (isset($arr_tab_key[$i])) {
                    $key = $arr_tab_key[$i];
                    if (isset($arr["tabs"][$key])) {
                        echo '<a href="' . $arr["tabs"][$key] . '" style="color:' . $arr["dropDownTabsColor"] . '; width:100%; font-weight:bolder" ><span class="droptabs">' . $arr_tab_key[$i] . '</span></a>';
                        echo '<div class="tab_spacing"></div>';
                    }
                } else {
                    echo '<a href="" style="color:' . $arr["dropDownTabsColor"] . ';width:100%; font-weight:bolder"><span>Entry' . ($i + 1) . '</span></a>';
                    echo '<div class="tab_spacing"></div>';
                }
            } else {
                echo '<a href="" style="color:' . $arr["dropDownTabsColor"] . ';width:100%; font-weight:bolder"><span>Entry' . ($i + 1) . '</span></a>';
