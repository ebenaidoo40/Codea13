<?php
    function pic_home(array $arr){
        if(!isset($arr["image1"])){
            $arr["image1"]="reze_frame_w/images/codea13.png";
        }
        if(!isset($arr["image2"])){
            $arr["image2"]="reze_frame_w/images/codea13.png";
        }
        if(!isset($arr["image3"])){
            $arr["image3"]="reze_frame_w/images/codea13.png";
        }
