...
<div style="font-size: 24px; text-align:center; font-weight:bold; margin-bottom:20px; color:'.$arr["buttonBackgroundColor"].'" id="form_heading">Log in</div>
    ...
    <div style="font-weight:bold; text-align:center">Not a member yet? <a href="../pg/store.php">Sign up</a> to be a member</div>
</form>
...
forgotPassword.addEventListener("click", function(){
    ...
    document.querySelector("#form").setAttribute("action", "../bke/resetpassword.php");
    ...
    toggleInput="login";
        ...
        document.querySelector("#form").setAttribute("action", "../bke/login.php");
